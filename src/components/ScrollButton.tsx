  ...
  return (
    <div>
      {scrollPosition > showButtonThreshold && (
        <ScrollBtnTop onClick={scrollToTop}>
          <svg
	...
	c0.2,0.2,0.4,0.3,0.7,0.3l0,0c0.3,0,0.5-0.1,0.7-0.3C17.3,14.4,17.3,13.8,16.9,13.4z"
      ...
      {Math.abs(scrollPosition - (document.body.scrollHeight - window.innerHeight)) > threshold && (
        <ScrollBtnBottom onClick={scrollToBottom}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="DownArrow">
            <path
